            ...
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form id="form" className="space-y-4 md:space-y-6" onSubmit={handleSignIn}>
                    <div>
                        ...
                        <input type="email" name="email" id="email" pattern="^[a-z.0-9]+@[a-z0-9]+.[a-z]{2,}$" className="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter your email" required/>
                    </div>
                    <div>
                    ...
                    <button type="submit" className="w-full text-white bg-indigo-400 outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-indigo-600 transition-all duration-500 ease-in">Sign in</button>
